...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="🏡𝐎𝐅𝐅𝐈𝐂𝐄🏡", url=f"https://t.me/EBD_524"),
    ],
    [
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="📍𝐎𝐖𝐍𝐄𝐑📍", url=f"https://t.me/EBD_524"
                        ),
                        InlineKeyboardButton(
                            text="🎄𝐑𝐄𝐏𝐎🎄", 
                            url="https://t.me/QUEEN_NETWORK",
                        ),
                    ],
                    [
...
☆............𝙱𝚈 » [QN ROBOT](https://t.me/QN_ROBOT)............☆
""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
...
╔═════ஜ۩۞۩ஜ═════╗
  ...
  ♨️𝗠𝗔𝗗𝗘 𝗕𝗬 [𝐐𝐍 𝐑𝐎𝐁𝐎𝐓](https://t.me/QN_ROBOT)♨️
